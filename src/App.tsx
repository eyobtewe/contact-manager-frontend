...
function App() {
    ...
    return (
        ...
        // <div className="flex flex-col md:flex-row gap-4 p-4 h-screen max-h-screen">
        //     <div className="hidden md:block md:basis-[10%] lg:basis-[10%] flex-shrink-0">
        //         <LeftSidebar />
        //     </div>
        //     <div className={`md:basis-[45%] lg:basis-[30%] flex-shrink-0 ${mobileView !== 'list' ? 'hidden md:block' : ''}`}>
        //         <ContactList />
        //     </div>

        //     <div className={`md:basis-[45%] lg:basis-[60%] flex-1 ${mobileView === 'list' ? 'hidden md:block' : ''} ${(!selectedContact && !isCreating) ? 'hidden' : ''}`}>
        //         <ContactDetails />
        //     </div>
        // </div>
    )
